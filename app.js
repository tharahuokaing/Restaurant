...
const imperialMenu = [
    { id: 1, name: "អាម៉ុកត្រី", english_name: "Fish Amok", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Fish+Amok" },
    { id: 2, name: "សម្លកកូរ", english_name: "Samlor Korko", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Samlor+Korko" },
    { id: 3, name: "ឡុកឡាក់សាច់គោ", english_name: "Beef Lok Lak", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Beef+Lok+Lak" },
    { id: 4, name: "នំបញ្ចុកសម្លប្រហើរ", english_name: "Num Banh Chok", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Num+Banh+Chok" },
    { id: 5, name: "សម្លម្ជូរគ្រឿងសាច់គោ", english_name: "Beef Sour Soup", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Beef+Sour+Soup" },
    { id: 6, name: "ក្តាមឆាម៉េចខ្ចី", english_name: "Fried Crab", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Fried+Crab" },
    { id: 7, name: "សម្លខ្ទិះត្រីប្រឡាក់", english_name: "Fish Coconut Curry", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Fish+Coconut+Curry" },
    { id: 8, name: "បាយសាច់ជ្រូក", english_name: "Bai Sach Chrouk", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Bai+Sach+Chrouk" },
    { id: 9, name: "ញាំស្វាយខ្ចីត្រីឆ្អើរ", english_name: "Green Mango Salad", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Green+Mango+Salad" },
    { id: 10, name: "សាច់ជ្រូកខ្វៃ", english_name: "Crispy Roasted Pork", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Crispy+Roasted+Pork" },
    { id: 11, name: "ឆាបាយសាច់ជ្រូក", english_name: "Pork Fried Rice", price: 2.50, category: "Food", stock: 0, image_url: "https://via.placeholder.com/150?text=Pork+Fried+Rice" },

    { id: 12, name: "Red Label 1L", english_name: "Whisky", price: 15.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Red+Label+1L" },
    { id: 13, name: "Black Label 1L", english_name: "Whisky", price: 30.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Black+Label+1L" },
    { id: 14, name: "Gold Label 1L", english_name: "Whisky", price: 50.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Gold+Label+1L" },
    { id: 15, name: "Platinium 75ml", english_name: "Whisky", price: 18.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Platinum+75ml" },
    { id: 16, name: "Blue label 75ml", english_name: "Whisky", price: 180.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Blue+Label+75ml" },
    { id: 17, name: "Penfold Bin 2", english_name: "Wine", price: 22.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Penfold+Bin+2" },
    { id: 18, name: "Penfold Bin 9", english_name: "Wine", price: 30.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Penfold+Bin+9" },
    { id: 19, name: "Penfold Bin 389", english_name: "Wine", price: 100.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Penfold+Bin+389" },
    { id: 20, name: "Gold XR 21Y", english_name: "Whisky", price: 105.00, category: "Alcohol", stock: 4, image_url: "https://via.placeholder.com/150?text=Gold+XR+21Y" },
    { id: 21, name: "Doble Black 1L", english_name: "Vodka", price: 35.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Double+Black+1L" },
    { id: 22, name: "Ciroc", english_name: "Vodka", price: 35.00, category: "Alcohol", stock: 0, image_url: "https://via.placeholder.com/150?text=Ciroc+Vodka" }
];
